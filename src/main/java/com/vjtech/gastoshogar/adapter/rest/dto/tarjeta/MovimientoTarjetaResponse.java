...
public class MovimientoTarjetaResponse {
    private UUID id;
    ...
    public MovimientoTarjetaResponse() {}

    public MovimientoTarjetaResponse(UUID id, String descripcion, String fechaCompra, String fechaCorte, BigDecimal importe, String tipo, String categoriaId, Integer cuotas, Integer cuotaActual, String estado, Instant createdAt, Instant updatedAt) {
        this.id = id;
